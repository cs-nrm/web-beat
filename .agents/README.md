...
**Los dos se corrigen a la vez.** Una definición y su contexto que se
...
- `analytics`, `content`, `frontend` y `streaming` — 2026-09-08. Entre las
...
- **Ya no se dice «v2».** Era el entorno de prueba que se convirtió en el sitio;
  ...
  sitio viejo». El nombre sigue vivo donde no es texto —`/var/www/web-beat-v2`,
...
- **Tres documentos de la raíz que eran del sitio viejo YA SE BORRARON:**
