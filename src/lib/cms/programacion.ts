 ...
 *
 * Este archivo es SOLO el CMS: qué se pide y con qué filtros. La aritmética
...
/*
  ...
  Aquí había además `obtenerParrillaDeHoy()`, que devolvía solo la parrilla del
...
/*
  NO HAY CLASIFICACIÓN DE PROGRAMAS, y es decisión de Carlos (2026-09-09):
 ...
 * `lib/parrilla.ts`.
 *
 * NO devuelve la lista de programas. La devolvía, para las tarjetas de «SHOWS
 ...
 *
 * Y por eso el reloj se resuelve UNA vez y se pasa hacia abajo: si cada
 ...
 *
 * Sin `catch`, como `obtenerNota` y `obtenerEspecial`: quien llama tiene que
