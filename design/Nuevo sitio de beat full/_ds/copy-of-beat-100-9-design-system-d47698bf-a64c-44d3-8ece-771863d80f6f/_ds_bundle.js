...
function Header({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    style: {
      display: 'flex',
      gap: 'clamp(var(--s-4), 1.4vw, var(--s-7))',
      flex: 1,
      minWidth: 0,
      overflow: 'hidden'
    }
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      position: 'absolute',
      inset: 0,
      background: 'radial-gradient(58% 78% at 76% 4%, rgba(255,110,147,.13), transparent 62%), radial-gradient(52% 70% at 4% 100%, rgba(255,162,75,.09), transparent 64%), linear-gradient(180deg, var(--noche-1), var(--noche-0))',
    ...
    style: {
      ...
      overflow: 'hidden',
      background: 'linear-gradient(165deg, var(--noche-2) 12%, var(--noche-1) 62%, #000)',
      display: 'grid',
      placeItems: 'center'
    }
  ...
  }, "Retrato en movimiento", /*#__PURE__*/React.createElement("br", null), "4:5 \xB7 negro + estelas"))));
}
function HomeScreen({
  onRoute,
  onPlay,
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Hero, {
    ...
    style: {
      ...
      borderRadius: 'var(--r-panel)',
      overflow: 'hidden',
      background: 'linear-gradient(160deg, var(--noche-2), var(--noche-0))',
