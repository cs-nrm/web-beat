 ...
 *
 * Se compara en minúsculas y sin espacios de sobra, no por igualdad estricta:
 ...
 *
 * Y el orden importa: gana `lugar`, que es el más específico de los dos. Si
 ...
 *
 * Se comparan las PARTES formateadas y no `getTime()` ni un `toISOString()`
