...
Este proyecto ya tenia documentacion operativa en `agents/*.md`.

La carpeta `.agents/agents/` agrega las definiciones reales que Codex puede descubrir como agentes del repositorio.

Mapeo actual:
- `ads.yaml` -> `agents/ads.md`
